                                ...
                                <tr>
                                    ...
                                    <td class=''>
                                        @if ($user->account_status == 'active')
                                            <span class="label text-success d-flex justify-content-center mr-2">
                                                <div class="dot-label bg-success"></div>{{ 'مفعل' }}
                                            </span>
                                        @else
                                            <span class="label text-danger d-flex justify-content-center mr-2">
            ...
            <div class="modal-content modal-content-demo">
                ...
                <form action="{{ route('users.destroy', 'delete') }}" method="post">
                    ...
                    <div class="modal-body">
                        <p>هل انت متاكد من حذف المستخدم ؟</p><br>
