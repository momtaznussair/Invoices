                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <select name="Section" class="form-control SlectBox">
                                    ...
                                    @foreach ($sections as $section)
                                        @if($section->id != $invoice->product->section->id)
                            ...
                            <div class="col">
                                ...
                                <select id="product_id" name="product_id" class="form-control">
                                    ...
                                    @foreach ($invoice->product->section->products as $product)
                                        @if($product->id != $invoice->product->id)
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            ...
            $(`select[name="Rate_VAT"]>option[value="{{$invoice->Rate_VAT}}"]`).prop('selected', true);
