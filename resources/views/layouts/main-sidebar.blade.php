...
<aside class="app-sidebar sidebar-scroll">
	<div class="main-sidebar-header active d-flex justify-content-center">
		...
		<a class="ml-1" href="{{ url('/' . $page='index') }}">
			<img src="{{URL::asset('assets/img/brand/favicon.png')}}" class="main-logo" alt="logo">
		</a>
		<span class='text-center font-weight-bold' style="font-size: 1.5rem;">Invoices</span>
			...
			<li class="slide">
				...
				<ul class="slide-menu">
					...
					@can('invoices archive')
						<li><a class="slide-item" href="{{ url('/' . $page='archived-invoices') }}">الأرشيف</a></li>
					@endcan
