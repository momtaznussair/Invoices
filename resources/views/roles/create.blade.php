                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 mb-5">
                       <div class='ht-15 mb-2'>
                        <a class="fas fa-check-circle text-success" id="sAll" onclick="selectAll();">&nbsp;تحديد كل الصلاحيات</a>
                        <a class="far fa-check-circle text-secondary" id="dAll" onclick="deSelectAll();">&nbsp;إلغاء تحديد كل الصلاحيات</a>
                       </div>
                        <ul id="treeview1">
                            ...
                            <label
                                style="font-size: 16px; display:block; margin-right:.4rem;">{{ Form::checkbox('permissions[]', $permission->id, false, array('class' => 'name')) }}
